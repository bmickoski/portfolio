export const metadata = {
  ...
  description:
    "A generic editor wrapper with a stable contract surface, allowing editor implementations to be swapped without refactoring every consuming form or screen.",
};
